...
// ponytail: naming/region adapted for the HostedOBOAgent private-network fork.
// Upstream defaults (westus, gpt-4.1, agent-vnet-test) are kept as documentation
// in the template's own README; only the values below are project-specific.
param location = 'westus3'
param aiServices = 'fdrobowus3'
param modelName = 'gpt-4.1-mini'
param modelFormat = 'OpenAI'
param modelVersion = '2025-04-14'
param modelSkuName = 'GlobalStandard'
param modelCapacity = 30
param firstProjectName = 'obo-project'
param projectDescription = 'Private Foundry project for the hosted Graph OBO agent'
param displayName = 'obo-project'
